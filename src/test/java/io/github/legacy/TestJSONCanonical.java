package io.github.legacy;

import static org.junit.jupiter.api.Assertions.assertEquals;

import io.github.legacy.models.Link;
...
class TestJSONCanonical {
  ...
  public void testCanonicalJSONEdgeCases() throws IOException {
    ...
    String referenceCanonicalLinkHex =
        "7b225f74797065223a226c696e6b222"
    ...
    // environment field
    String linkString =
        new String(Files.readAllBytes(Paths.get("src/test/resources/testvalues.link")));
    ...
    assertEquals(
        Hex.toHexString(link.getCanonicalJSON(true).getBytes()), referenceCanonicalLinkHex);
  }
}
