...
class RSAKeyTest {
   ...
   *
   * <p>Test methods to serialize a public key FIXME: will wait for junit-pioneer to add
   * TempDirectory for this test
   */
  ...
  public void testComputeKeyID() throws IOException {
    ...
    assertEquals(
        key2.computeKeyId(), "0b70eafb5d4d7c0f36a21442fcf066903d09cf5050ad0c8443b18f1f232c7dd7");
    keyfile2.delete();
  }
}
