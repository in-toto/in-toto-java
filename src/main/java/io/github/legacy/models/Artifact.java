...
public class Artifact {
  ...
  /**
   * An ArtifactHash containing the hash of the contents of the file following the hash object
   * definition in the in-toto specification.
   */
  private ArtifactHash hash;

  /**
   * Default constructor, uses a filename to collect and automatically hash the contents of the
   * file.
   *
   * <p>This constructor does *not* perform file locking, so use with care.
   *
   * @param filename The filename (relative or absolute) of the Artifact to record (i.e., hash).
   */
  ...
  /**
   * Nested subclass representing a hash object compliant with the in-toto specification. <code>
   *  {"sha256": "...",
   *   "sha512": "..."
   *  }
   * </code>
